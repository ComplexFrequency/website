...
When thinking about designing a detector, you initially think of simple threshold methods. For example: if the signal crosses $$+T$$ or $$-T$$, trigger a detection. You immediately discard this idea, becau, becausee an intruder doesn't produce one big sample; it produces thousands of slightly bigger ones. Then, you think of different ways to measure signal variability: amplitude, standard deviation, zero-crossing rate, even spectral energy. What if, instead, there were a mathematically proven method to solve this problem?
